...
UBUNTU_TRANSLATION_DOMAIN="metra.jaft"
...
aptest.commands = bash $$PWD/Metra/tests/autopilot/run
aptest.depends  = sub-Metra

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Metra/tests/unit 
unittest.depends  = sub-Metra
